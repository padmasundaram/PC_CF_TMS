function [xi,yi,L1,L2] = linexline(L1x, L1y, L2x, L2y, showIntersectionPlot)
%%***********************************************************************%
...
if showIntersectionPlot
    % Plot the lines
    L1 = plot([x1 x2], [y1 y2], 'Color','k', 'LineWidth', 2, 'LineStyle', '--');
    hold on;
    L2 = plot([x3 x4], [y3 y4], 'Color','k', 'LineWidth', 2, 'LineStyle', '--');
